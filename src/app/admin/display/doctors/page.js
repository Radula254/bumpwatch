                ...
                <tbody>
                  {users.map((user, index) => (
                    <tr key={user._id || index} className="even:bg-gray-100 odd:bg-white">
                      ...
                      <td className="py-3 px-4">{user?.doctorInfo?.city || "N/A"}</td>
                      <td className="py-3 px-4">{user?.doctorInfo?.country || "N/A"}</td>
                      <td className="py-3 px-4">{user?.doctorInfo?.phone || "N/A"}</td>
                      <td className="py-3 px-4">{user?.doctorInfo?.postalCode || "N/A"}</td>
                      <td className="py-3 px-4">{user?.doctorInfo?.salary || "N/A"}</td>
                      <td className="py-3 px-4">{user?.doctorInfo?.streetAddress || "N/A"}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
